  ...
  return (
    <div className="h-16 bg-[#FFFFFF] border-b border-[#E5E5E5] flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div className="flex items-center gap-2 md:gap-4 flex-1">
        ...
        <div className="hidden md:block md:w-[448px] relative">
      ...
      <div className="flex items-center gap-3 md:gap-4">
        {/* Mobile Search Icon */}
        <button className="md:hidden text-[#737373] hover:text-[#111111] transition-colors p-1 rounded hover:bg-gray-100">
